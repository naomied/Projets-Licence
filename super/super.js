...
var obj = JSON.parse(databaseString);

function stringJsonToArray(obj) {
  var tmp = [];
...
var databaseArray = stringJsonToArray(obj);

class SuperHero {
  constructor(nom, powerStats, weight, alignment, urlImage) {
    this.nom = nom;
  ...
  getSumStats() {
    let sum = 0;
    for (let i in this.powerStats) {
      sum += this.powerStats[i];
    }
    return sum;
  }
  compareSuper(heros2) {
    let statsHeros1 = this.getSumStats();
    let statsHeros2 = heros2.getSumStats();
    if (statsHeros1 > statsHeros2) {
      return 1;
    } else if (statsHeros1 < statsHeros2) {
      return -1;
    } else {
      return 0;
    }
  ...
  affiche() {
    ...
    //initialisation éléments de la ligne 1

    let row1 = document.createElement("tr");
    let cell1 = document.createElement("td");
    let image = new Image();
    image.src = this.urlImage;
    cell1.appendChild(image);
    cell1.rowSpan=5;
    row1.appendChild(cell1);
    let cell2 = document.createElement("th");
    cell2.appendChild(document.createTextNode(this.nom));
    cell2.colSpan=2;
    row1.appendChild(cell2);
    let cell3 = document.createElement("td");
    cell3.appendChild(document.createTextNode(this.alignment));
    row1.appendChild(cell3);

    //initialisation éléments de la ligne 2

    let row2 = document.createElement("tr");
    let cell4 = document.createElement("td");
    cell4.appendChild(document.createTextNode("Intelligence"));
    row2.appendChild(cell4);
    let cell5 = document.createElement("td");
    cell5.appendChild(document.createTextNode("Strength"));
    row2.appendChild(cell5);
    let cell6 = document.createElement("td");
    cell6.appendChild(document.createTextNode("Speed"));
    row2.appendChild(cell6);

    //initialisation éléments de la ligne 3

    let row3 = document.createElement("tr");
    let cell7 = document.createElement("td");
    cell7.appendChild(document.createTextNode(this.powerStats["intelligence"]));
    row3.appendChild(cell7);
    let cell8 = document.createElement("td");
    cell8.appendChild(document.createTextNode(this.powerStats["strength"]));
    row3.appendChild(cell8);
    let cell9 = document.createElement("td");
    cell9.appendChild(document.createTextNode(this.powerStats["speed"]));
    row3.appendChild(cell9);

    //initialisation éléments de la ligne 4

    let row4 = document.createElement("tr");
    let cell10 = document.createElement("td");
    cell10.appendChild(document.createTextNode("Durability"));
    row4.appendChild(cell10);
    let cell11 = document.createElement("td");
    cell11.appendChild(document.createTextNode("Power"));
    row4.appendChild(cell11);
    let cell12 = document.createElement("td");
    cell12.appendChild(document.createTextNode("Combat"));
    row4.appendChild(cell12);

    //initialisation éléments de la ligne 5

    let row5 = document.createElement("tr");
    let cell13 = document.createElement("td");
    cell13.appendChild(document.createTextNode(this.powerStats["durability"]));
    row5.appendChild(cell13);
    let cell14 = document.createElement("td");
    cell14.appendChild(document.createTextNode(this.powerStats["power"]));
    row5.appendChild(cell14);
    let cell15 = document.createElement("td");
    cell15.appendChild(document.createTextNode(this.powerStats["combat"]));
    ...
    cell9.style.width = "80px";
    cell10.style.width = "80px";
    cell11.style.width = "80px";
    cell12.style.width = "80px";
    cell13.style.width = "80px";
    cell14.style.width = "80px";
    cell15.style.width = "80px";

    //pose des lignes sur le tableau
...
function creerTableauSuper(databaseArray) {
  var res = databaseArray.map((obj) => new SuperHero(obj.name, obj.powerstats, obj.appearance.weight[1], obj.biography.alignment, obj.images.sm));
  return res;
}

var superHerosArray = creerTableauSuper(databaseArray);

function poidsTotalSuper(superHerosArray) {
  var sum = 0;
  for (let i in superHerosArray) {
    sum += i.weight;
  }
  return sum;
}
...
function start() {
  for (let i=0; i<superHerosArray.length; i++){
    superHerosArray[i].affiche();
  }
}
